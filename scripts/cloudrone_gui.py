...
Attitude_bg = cv2.imread("/home/adisorn/catkin_ws/src/beginner_tutorials/scripts/Horizon_Background.png",-1)
Attitude_bg = cv2.cvtColor(Attitude_bg, cv2.COLOR_BGRA2RGBA)
Grnd_sky = cv2.imread("/home/adisorn/catkin_ws/src/beginner_tutorials/scripts/Horizon_GroundSky.png",-1)
Grnd_sky = cv2.cvtColor(Grnd_sky, cv2.COLOR_BGR2RGB)
Needle = cv2.imread("/home/adisorn/catkin_ws/src/beginner_tutorials/scripts/Maquette_Avion.png", -1)
Needle = cv2.cvtColor(Needle, cv2.COLOR_BGRA2RGBA)

Turn_bg = cv2.imread("/home/adisorn/catkin_ws/src/beginner_tutorials/scripts/Turn_Background.png")
...
def Throttle_1():
    ...
    pygame.event.get()
    Throttle_value_1 = Throttle_value_1 + 1*(joystick.get_button( 3 ))
    Throttle_value_1 = Throttle_value_1 - 1*(joystick.get_button( 0 ))
...
def Publish():
    ...
    Pitch_value_1 = Pitch_value_1*(-0.089255401/2) +7.160432099500501230000000000000000#(-Pitch_value_1 + 40)*4.10/80 + 5.45
    Roll_value_1 = Roll_value_1*(-0.089255401) + 7.1604320995005111000000000000000  #(-Roll_value_1 + 20)*4.10/40 + 5.45
    Yaw_value_1 = Yaw_value_1*(-0.032175)+7.1687552510000000000000000000000  #(-Yaw_value_1 + 50)*4.10/100 + 5.1125
